...
<div class="catalog-header mb-3">
    ...
    <p>Filtra y encuentra la propiedad que se ajuste a lo que buscas.</p>
</div>

<!-- Filtros de Búsqueda -->
<div class="card filter-card shadow-sm mb-4" style="margin-top:0;">
    <div class="card-body">
        <form method="GET" action="catalogo.jsp" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-12 text-end">
                <a href="catalogo.jsp" class="btn btn-outline-secondary me-2">Limpiar Filtros</a>
