...
<%
    ...
    int idInmobiliaria = 1, idTipo = 0, idCiudad = 0, habitaciones = 0, banos = 0;
    ...
    if (conn != null) {
        try {
            PreparedStatement stmtInmo = conn.prepareStatement("SELECT id_inmobiliaria FROM inmobiliaria LIMIT 1");
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        // Manejo seguro para evitar 'Out of range value for column area_m2'
        try {
...
<div class="container my-5" style="max-width: 900px;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="admin_propiedades.jsp" class="btn btn-outline-secondary">&larr; Volver al Panel</a>
    </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="formulario_propiedad.jsp<%= esEdicion ? "?id=" + idPropiedad : "" %>">
                ...
                <div class="mt-4 text-end">
                    <a href="admin_propiedades.jsp" class="btn btn-secondary me-2">Cancelar</a>
