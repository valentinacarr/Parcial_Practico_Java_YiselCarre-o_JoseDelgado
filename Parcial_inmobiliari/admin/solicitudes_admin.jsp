...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold m-0">Gestión de Solicitudes y Citas</h2>
            <p class="text-muted m-0">Aaprueba, rechaza o confirma solicitudes de clientes</p>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end px-4">
                                <% if ("PENDIENTE".equals(est)) { %>
                                    <a href="solicitudes_admin.jsp?tipo=solicitud&id=<%= idS %>&nuevo_estado=APROBADA" 
                                       class="btn btn-sm btn-success me-1">Aprobar</a>
                                    <a href="solicitudes_admin.jsp?tipo=solicitud&id=<%= idS %>&nuevo_estado=RECHAZADA" 
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end px-4">
                                <% if ("PENDIENTE".equals(estC)) { %>
                                    <a href="solicitudes_admin.jsp?tipo=cita&id=<%= idC %>&nuevo_estado=CONFIRMADA" 
                                       class="btn btn-sm btn-success me-1">Confirmar</a>
                                    <a href="solicitudes_admin.jsp?tipo=cita&id=<%= idC %>&nuevo_estado=RECHAZADA" 
                                       class="btn btn-sm btn-outline-danger">Rechazar</a>
                                <% } else if ("CONFIRMADA".equals(estC)) { %>
                                    <a href="solicitudes_admin.jsp?tipo=cita&id=<%= idC %>&nuevo_estado=REALIZADA" 
